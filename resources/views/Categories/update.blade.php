...
<body class="navbar-fixed sidebar-nav fixed-nav">
    <header class="navbar">
        <div class="container-fluid">
             ...
             <a href="{{ route('blogs.showAll') }}" class="btn btn-sm btn-primary" title="عودة">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-plus"></i> إتعديل فئة
                    ...
                    <div class="card-block">
                        ...
                        <form action="{{ route('categories.update',$category) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <a href="{{ route('categories.showAll') }}" class="btn btn-secondary">إلغاء</a>
                        </form>
                    </div>
                </div>
            </div>
