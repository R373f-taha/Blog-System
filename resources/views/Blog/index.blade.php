        ...
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-title">
                 ...
                 <li class="nav-item">
                    @role('admin')
                    <a class="nav-link" href="{{ route('blogs.create') }}"><i class="fa fa-book"></i> إضافة مدونة</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> قائمة المدونات
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('blogs.show', $blog) }}" class="btn btn-sm btn-primary" title="عرض">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            @role('admin')


                                             <a href="{{ route('blogs.edit', $blog) }}" class="btn btn-sm btn-warning" title="تعديل">
