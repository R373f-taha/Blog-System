...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('blogs.showAll') }}"> تعديل المدونة</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-plus"></i> تعديل مدونة
                    ...
                    <div class="card-block">
                        ...
                        <form action="{{ route('blogs.update',$blog) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image" id="image" class="form-control-file @error('image') is-invalid @enderror" accept="image/*  " value="{{ old('image',$blog->image) }}">
                                @error('image')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                                <small class="form-text text-muted">الصيغ المسموحة: jpeg, png, jpg, gif. الحد الأقصى 2 ميجابايت.</small>
                            </div>
                             <div class="form-group">
                                <label for="categories">الفئة</label>
                                <div>
                                    @foreach ($categories as $category )
                                        ...
                                        <label calss="form-check-label" for="category__{{ $category->id }}">
                                            {{ $category->name }}
                            ...
                            <a href="{{ route('blogs.showAll') }}" class="btn btn-secondary">إلغاء</a>
                        </form>
                    </div>
                </div>
            </div>
