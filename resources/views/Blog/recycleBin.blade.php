...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('blogs.showAll') }}"><i class="icon-speedometer"></i> عودة
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> قائمة المدونات المؤرشفة
                                     </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <form action="{{ route('blogs.forceDelete', $blog->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-danger" title="حذف نهائي" onclick="return confirm('هل أنت متأكد من الحذف؟')">
                                                    <i class="fa fa-trash"></i>
                                                </button>
                                            </form>
                                            <a href="{{ route('blogs.restore', $blog) }}" class="btn btn-sm btn-success" title="استعادة">
